...
public struct FakeExchangeRateService: ExchangeRateService {

    public init() {}

    public func fetchExchangeRate(from sourceCurrency: String, to targetCurrency: String, amount: Double) async throws -> Double {
